---
title: "Coldcard Release History - Mk4 / Mk5 (through 5.5.1, July 2026)"
source: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/releases/History-Mk.md"
type: articles
ingested: 2026-08-10
tags: [coldcard, changelog, release-history, mk4, mk5, psbt, bip-322, multisig, bugfixes, feature-archaeology]
summary: "Historic release notes for the Mk4 and Mk5 lines, ending at 5.5.1 (2026-07-01) and directing readers to ChangeLog.md for anything more recent. The most useful document for feature archaeology - when a capability appeared and when a mitigation shipped. The 5.5.1 entry alone records WIF Store watch-only descriptor export, WIF Store address detection without PSBT_IN_BIP32_DERIVATION for better Electrum support, BIP-322 Proof of Reserves and message signing now requiring PSBT_GLOBAL_GENERIC_SIGNED_MESSAGE, and a notable security fix for legacy input amount spoofing: witness-utxo-only PSBT inputs are rejected when Coldcard is expected to sign a non-segwit input, and where both UTXO fields are present the full non_witness_utxo is preferred for amount and script lookup. Other entries in that release cover NFC export tag liveness for iOS tap reliability, disabling Virtual Disk and NFC before activating HSM, repaired P2PK signing for both compressed and uncompressed spends, a Delta Mode Trick PIN that was never restored from backup, and several CCC and TX Explorer crash fixes. Earlier entries run back through the line's history and include the arrival of 2-megabyte PSBT support on Mk4 and the Advanced > Export XPUB path for BIP-84/44/49 XPUB, ZPUB, YPUB, XFP and master XPUB as QR, plus the change allowing a PSBT with a mismatched XFP to still be tried against the current XFP with a warning, which eases PSBT construction and can protect XFP privacy. Note: releases/History-Mk4.md and releases/History-Mk5.md are git symlinks to this same file."
collection: "coldcard"
adapter: git
upstream_id: "releases/History-Mk.md"
upstream_type: git-file
revision: "43b2139227149c281141d08c612afd13c434d456"
sha: "4d5f5bce689eb08cdcf08e1aff936415517edbac"
canonical_url: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/releases/History-Mk.md"
...
- Enhancement: BIP-322 Proof of Reserves and Message Signing PSBT
  ...
  (read more [BIP-322 Proof of Reserves documentation](https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/docs/proof-of-reserves-bip-322.md) )
