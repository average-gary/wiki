---
title: "BIP-85 Deterministic Passwords and USB Keyboard Emulation"
source: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/docs/bip85-passwords.md"
type: articles
ingested: 2026-08-10
tags: [coldcard, bip-85, passwords, keyboard-emulation, usb-hid, password-manager, derivation, pwd-base64]
summary: "Covers deriving deterministic passwords from the seed per BIP-85 PWD BASE64, turning the Coldcard into a specialized password manager. Up to 10,000 distinct passwords can be derived by index, and the device can type them into a host computer by emulating a USB keyboard. Requires a Mk4 or Mk5 on firmware 5.0.5+, or any Q, plus a USB-C cable with a data link (Coinkite's power-only cable will not work). Documents the flow: enable Settings > Keyboard EMU, after which a 'Type Passwords' entry appears below Address Explorer in the top menu; selecting it switches USB into keyboard-emulation mode, then a BIP-85 password index is chosen, the derivation path and password can be reviewed on screen, and pressing OK sends the keystrokes followed by Enter. Exiting turns keyboard emulation off and restores normal USB mode if it was previously enabled, otherwise leaves USB disabled. Also describes viewing BIP-85 passwords without typing them via Advanced/Tools > Derive Seed B85 > Passwords."
collection: "coldcard"
adapter: git
upstream_id: "docs/bip85-passwords.md"
upstream_type: git-file
revision: "43b2139227149c281141d08c612afd13c434d456"
sha: "43beb3de8796c1c9077a36db0d84e77b1cf49d82"
canonical_url: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/docs/bip85-passwords.md"
