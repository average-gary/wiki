---
title: "Airgapped 2-of-2 Multisig with Bitcoin Core and Descriptors"
source: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/docs/bitcoin-core2of2desc.md"
type: articles
ingested: 2026-08-10
tags: [coldcard, multisig, bitcoin-core, descriptors, 2of2, regtest, tutorial, jq, keypool]
summary: "Step-by-step tutorials for building an air-gapped 2-of-2 multisig with Bitcoin Core descriptor wallets. Prerequisites are a Coldcard Mk4, an SD card and reader (or NFC reader), bitcoind v23.0 and jq. Tutorial 1 - two Mk4 devices plus a bitcoin-qt watch-only coordinator - is hosted in full on coldcard.com. Tutorial 2 is given inline: a 2-of-2 between one Mk4 and a bitcoind software wallet, with a bitcoind watch-only wallet as coordinator, worked through on regtest. It walks the shell commands to start bitcoind, create a descriptor wallet with private keys enabled to act as the software signer (including the older pre-v23.0 createwallet argument form), and refill the signer's keypool to 100 - necessary because addresses are generated by the watch-only wallet, without which the signer can only sign index 0, and which must be repeated past 100 addresses."
collection: "coldcard"
adapter: git
upstream_id: "docs/bitcoin-core2of2desc.md"
upstream_type: git-file
revision: "43b2139227149c281141d08c612afd13c434d456"
sha: "238978049950ec55bbd933b573c995c26340631d"
canonical_url: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/docs/bitcoin-core2of2desc.md"
