---
title: "NFC Push Transaction (single-tap broadcast)"
source: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/docs/nfc-pushtx.md"
type: articles
ingested: 2026-08-10
tags: [coldcard, pushtx, nfc, broadcast, base64url, url-protocol, phone-browser, airgap]
summary: "Specifies NFC Push Tx, which broadcasts a freshly signed transaction with a single phone tap, completing the path PSBT in by SD/QR/NFC, signed on the Coldcard, tapped to a phone browser, relayed by a server to the Bitcoin network. Once configured with a URL under Settings > NFC Push Tx, the Coldcard shows an NFC animation after signing; tapping the phone reads an NFC tag containing a URL that carries the signed transaction, and opening it in the mobile browser loads a landing page that connects to a Bitcoin node or similar and broadcasts. Available on Q and Mk4 with NFC enabled. The protocol appends to a caller-supplied URL prefix the parameter t= holding the binary transaction in base64url (RFC 4648 section 5) and c= holding the rightmost 8 bytes of SHA256 over the transaction, also base64url encoded. Points at PushTx.org as the feature's minisite."
collection: "coldcard"
adapter: git
upstream_id: "docs/nfc-pushtx.md"
upstream_type: git-file
revision: "43b2139227149c281141d08c612afd13c434d456"
sha: "7abf6aea3b261a8085a1d2a2be3bfe66c7a588b9"
canonical_url: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/docs/nfc-pushtx.md"
