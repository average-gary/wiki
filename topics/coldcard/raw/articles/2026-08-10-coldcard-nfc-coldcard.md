---
title: "NFC Support on Coldcard (Mk4, Mk5, Q)"
source: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/docs/nfc-coldcard.md"
type: articles
ingested: 2026-08-10
tags: [coldcard, nfc, iso-15693, nfc-v, ndef, antenna, psbt-transfer, address-verification, standards-paywall]
summary: "Covers NFC on the NFC-equipped models, starting with the practical problem of finding the antenna: on Mk4 it is a PCB trace loop centered under the 8 key, on Mk5 a discrete coil (L6) in the top-right corner, and on the Q1 a flexible sticker antenna behind the display - where the green D12 LED below the bottom-right of the display is the transfer activity indicator, not the antenna itself. Advises locating both the Coldcard's and the phone's antenna, since phone antennas are rarely marked. Includes a pointed standards-background section: because ISO and the NFC Forum sell their specifications - membership costing thousands of dollars or hundreds per PDF - Coinkite cannot link to reference standards and must instead 'hand-wave about our interpretation of their standards documents,' a policy it argues is against the public interest and hinders adoption and interoperability. Then documents the lower layers, security considerations, desktop testing, and the record types: simple data (general QR replacement, payment address) and complex data (text label, SHA256 checksum, TXID value, PSBT file, Bitcoin transaction, JSON files), closing with examples."
collection: "coldcard"
adapter: git
upstream_id: "docs/nfc-coldcard.md"
upstream_type: git-file
revision: "43b2139227149c281141d08c612afd13c434d456"
sha: "3ce0efbfdfd6c75c17abfe7ec277df814040d541"
canonical_url: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/docs/nfc-coldcard.md"
...
![nfc tap sweet-spots per model](https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/docs/nfc-tap-locations.png)
...
![iphone_nfc](https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/docs/iphone_nfc.jpg)
