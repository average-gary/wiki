---
title: "Coldcard Generic JSON Wallet Export Format"
source: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/docs/generic-wallet-export.md"
type: articles
ingested: 2026-08-10
tags: [coldcard, wallet-export, json, xpub, xfp, bip-44, bip-49, bip-84, bip-48, bip-45, descriptors]
summary: "Defines Coldcard's general-purpose JSON export, offered alongside its wallet-specific formats and intended for future wallet makers to adopt. The file carries the master XPUB and its XFP plus derived values for the top hardened position of the single-signature schemes BIP-44, BIP-49 and BIP-84, and for the multisig schemes BIP-48 (bip48_1 for .../1h P2SH-P2WSH and bip48_2 for .../2h P2WSH). A BIP-45 (m/45h) multisig section is included only when the account number is zero and is omitted for non-zero accounts. Reachable at Advanced/Tools > Export Wallet > Generic JSON, with an invitation to contact Coinkite or open a pull request for additional fields, and a complete worked example produced by the Simulator for account number 123 showing the chain, xfp, account, xpub and per-scheme sub-objects."
collection: "coldcard"
adapter: git
upstream_id: "docs/generic-wallet-export.md"
upstream_type: git-file
revision: "43b2139227149c281141d08c612afd13c434d456"
sha: "c6fe981f45a54d04ca9815c93ae74b44623bc096"
canonical_url: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/docs/generic-wallet-export.md"
