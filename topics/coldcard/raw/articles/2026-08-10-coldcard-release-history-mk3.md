---
title: "Coldcard Release History - Mk3 (through 4.2.0, July 2026)"
source: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/releases/History-Mk3.md"
type: articles
ingested: 2026-08-10
tags: [coldcard, changelog, release-history, mk3, entropy-bug, hotfix, seed-generation, legacy-hardware, feature-archaeology]
summary: "Historic release notes for the Mk3 line, from the initial public release 1.0.0r2 in August 2018 through 4.2.0 on 31 July 2026. Opens with a standing warning: as of July 2026, do not generate seeds on Mk3 hardware without the fixed 4.2.0 version, and move funds to new seeds or a BIP-39 derived secret, pointing to the Coinkite blog announcement. The 4.2.0 release is described simply as a hotfix correcting the entropy bug and allowing new seed generation on old hardware, which makes this file the clearest record of how the 2026 entropy advisory was resolved for legacy devices. The remaining entries trace five years of Mk3 development, including the introduction of Seed XOR with its paper tools and updates to the Bitcoin Core usage guidance, down to the earliest releases."
collection: "coldcard"
adapter: git
upstream_id: "releases/History-Mk3.md"
upstream_type: git-file
revision: "43b2139227149c281141d08c612afd13c434d456"
sha: "5bb092811e680bd7b52a6ed6da6921ae06f55263"
canonical_url: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/releases/History-Mk3.md"
...
- New feature: Seed XOR -- split your secret BIP-39 seed into 2 (or 3 or 4) new seed phrases
    ...
    - see [docs/seed-xor.md](https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/releases/docs/seed-xor.md) for more, and the paper tools you need
...
- Export a command file for Bitcoin Core to create an air-gapped, watch-only wallet.
  ...
  [docs/bitcoin-core-usage.md](https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/releases/docs/bitcoin-core-usage.md) has been updated.
