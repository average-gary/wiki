---
title: "Coldcard Firmware Upgrade and Recovery Process"
source: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/docs/upgrade-recovery.md"
type: articles
ingested: 2026-08-10
tags: [coldcard, firmware-upgrade, psram, world-checksum, bricking, power-fail, recovery, dfu, flash-bit-flips]
summary: "Applies to Mk4, Mk5 and Q, which replaced the slow external SPI serial flash of Mk1-Mk3 with a 64 Mbit ESP-PSRAM64H quad-SPI PSRAM chip. That chip is volatile, which is fine as PSBT working space but risky mid-upgrade, and this document explains how the resulting bricking hazard is handled. The upgrade sequence: the DFU image (up to about 1.5MB) is copied in by USB or SD card and staged in PSRAM; the user approves and enters the main PIN; the image's factory signature is checked and nothing proceeds without it; a 'world checksum' is computed over the new firmware plus current flash contents including the bootloader, its secrets and the MCU's unique identity bits; that checksum is written to SE1 (the 608C) before anything else, since knowledge of it is required at boot to light the green genuine light; flash erase and write then take about 15 seconds, after which the system resets and re-verifies the signature, coming up green because the checksum was written in advance. Then covers the recovery cases - PSRAM still holding the new firmware, recovering from power failures - plus the key entry sequence and the practical reality of bit flips in flash."
collection: "coldcard"
adapter: git
upstream_id: "docs/upgrade-recovery.md"
upstream_type: git-file
revision: "43b2139227149c281141d08c612afd13c434d456"
sha: "59e1cc760198214f3c221a376b1ae59ce5e910cf"
canonical_url: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/docs/upgrade-recovery.md"
