---
title: "Coldcard PIN Design and Operation"
source: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/docs/pin-entry.md"
type: articles
ingested: 2026-08-10
tags: [coldcard, pin, anti-phishing, duress-wallet, brick-me, rate-limiting, code-signing, genuine-light, key-layout, evil-maid]
summary: "The largest document in the set (818 lines) and the definitive account of PIN handling. Walks the full entry sequence: a 2-6 digit prefix, the two BIP-39 anti-phishing words unique to that Coldcard and prefix (the evil-maid check - if the words are wrong, stop and do not enter the rest of the PIN), optional secondary-wallet selection, then the 2-6 digit suffix. Documents the ordered checks that follow: the user-defined 'brick me' PIN, which wipes the secure element and irreversibly bricks the device immediately with no delay by rolling the pairing secret to a forgotten value; the punitive delay computed from the attempt counter versus the last successful attempt level; and the duress-wallet PIN, which silently opens a decoy wallet as though it were the wallet the user selected. Covers where the PIN is actually stored, PIN-to-secret-value hashing, the genuine-versus-caution light and its relationship to code signatures and the production-versus-development signing key, the four wallet types on one device, recovering funds from a duress wallet, the hazards of changing duress PIN codes, the Mark 2 and Mark 3 key layouts, 'knowledge of' keys, and the secure rate-limiting of PIN retries including the pre-Mark-3 delay policy and the Mark 3 rate-limiting method."
collection: "coldcard"
adapter: git
upstream_id: "docs/pin-entry.md"
upstream_type: git-file
revision: "43b2139227149c281141d08c612afd13c434d456"
sha: "b9eae7b5a9ee7a280f1f6b51f16e25890f36f75a"
canonical_url: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/docs/pin-entry.md"
...
![dev-warning screen](https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/docs/dev-warning.png)
