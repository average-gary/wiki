---
title: "Notes on Coldcard Reproducible Builds"
source: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/docs/notes-on-repro.md"
type: articles
ingested: 2026-08-10
tags: [coldcard, reproducible-builds, docker, makefile, supply-chain, verification, signit, submodules]
summary: "Walks through how `make repro` actually verifies reproducibility, annotating the entrypoint rules in stm32/shared.mk. The repro target depends on submods-match and code-committed - ensuring submodules and the working tree are clean - then builds and runs a Docker image, passing the version string, the hardware model (mk4, q1) and the parent makefile (MK-Makefile or Q1-Makefile). Annotated Docker log excerpts show the process mounting a tmpfs at /tmp/checkout, pulling the official release from coldcard.com into it, cloning /work/src/.git, initialising submodules, installing signit, and building so the resulting bytes can be compared against the shipped binary. Also documents the check-repro step. This is the operational detail behind the claim that a user can rebuild the tree and get exactly the same bytes as the firmware on their device."
collection: "coldcard"
adapter: git
upstream_id: "docs/notes-on-repro.md"
upstream_type: git-file
revision: "43b2139227149c281141d08c612afd13c434d456"
sha: "310667096112463c8d9159b3eab5f610db8becff"
canonical_url: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/docs/notes-on-repro.md"
