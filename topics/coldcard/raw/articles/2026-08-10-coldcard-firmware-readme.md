---
title: "Coldcard Firmware README (with 2026 entropy security advisory)"
source: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/README.md"
type: articles
ingested: 2026-08-10
tags: [coldcard, readme, security-advisory, entropy-bug, reproducible-builds, docker, firmware, seed-generation, cve-like]
summary: "The repository's front page, which at this revision opens with a live security advisory rather than an introduction: versions from 2021 to July 2026 had a bug producing poor entropy, and any secrets generated on a Coldcard in that period should be regenerated with funds moved on chain immediately. Master seeds are stated to be trustworthy only from releases after 5.6.0 (Mk4, Mk5), 1.5.0Q (Q1), 4.2.0 (Mk3) and 6.6.0 (Edge Mk/Q). A BIP-39 passphrase mitigates some risk but only to the extent of the entropy the passphrase itself adds, and dice rolls contribute 2.5 bits each. Links the Coinkite blog post and the technical backgrounder on the bug. The remainder is the normal README: product framing as an affordable, ultra-secure and verifiable Bitcoin hardware wallet, quick links to the changelog, PGP signature file and firmware binaries, and the reproducible-build instructions - install Docker and GNU Make, check out a specific version, and rebuild to get exactly the same bytes as the shipped binary."
collection: "coldcard"
adapter: git
upstream_id: "README.md"
upstream_type: git-file
revision: "43b2139227149c281141d08c612afd13c434d456"
sha: "a3bfdf1920bcd5b2e87423221aa35b17cfa8fc0c"
canonical_url: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/README.md"
...
- [Latest firmware changes and updates](https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/releases/ChangeLog.md)
- [PGP signature file](https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/releases/signatures.txt)
