---
title: "BIP-322 Generic Signed Message Format and Proof of Reserves"
source: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/docs/proof-of-reserves-bip-322.md"
type: articles
ingested: 2026-08-10
tags: [coldcard, bip-322, proof-of-reserves, psbt, to-spend, to-sign, witness-utxo, multisig, signed-message]
summary: "Specifies how Coldcard acts as a BIP-322 PSBT signer for Proof of Reserves. The device validates the BIP-322 to_sign transaction, displays the message from PSBT_GLOBAL_GENERIC_SIGNED_MESSAGE and adds signatures, leaving finalization and encoding of the final BIP-322 signature string to the finalizer. Enumerates the strict requirements a PoR PSBT must satisfy: PSBT_GLOBAL_GENERIC_SIGNED_MESSAGE (0x09) must be present, its value being the exact message shown to the user and signed, decoding to something non-empty and at most 330 characters; every input needs PSBT_IN_BIP32_DERIVATION; P2SH-wrapped segwit inputs need PSBT_IN_REDEEM_SCRIPT and P2WSH inputs need PSBT_IN_WITNESS_SCRIPT; to_sign needs at least one input; input 0 must spend the BIP-322 to_spend output and must carry either PSBT_IN_NON_WITNESS_UTXO or PSBT_IN_WITNESS_UTXO. When input 0 supplies only a witness UTXO, Coldcard reconstructs the expected to_spend txid from the message and the witness UTXO's scriptPubKey; when it supplies a non-witness UTXO, that must be the full BIP-322 to_spend transaction."
collection: "coldcard"
adapter: git
upstream_id: "docs/proof-of-reserves-bip-322.md"
upstream_type: git-file
revision: "43b2139227149c281141d08c612afd13c434d456"
sha: "4d2d66ba93dd446b006dbc50876e09179524d6af"
canonical_url: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/docs/proof-of-reserves-bip-322.md"
