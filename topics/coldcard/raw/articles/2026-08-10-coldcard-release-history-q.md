---
title: "Coldcard Release History - Q (through 1.4.1Q, July 2026)"
source: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/releases/History-Q.md"
type: articles
ingested: 2026-08-10
tags: [coldcard, changelog, release-history, q1, bip-322, psbt, ccc, qr, bugfixes, feature-archaeology]
summary: "Historic release notes for the Coldcard Q line, ending at 1.4.1Q (2026-07-01) with more recent changes in ChangeLog.md. The 1.4.1Q entry mirrors the Mk4/Mk5 5.5.1 release: WIF Store watch-only descriptor export, WIF Store address detection without PSBT_IN_BIP32_DERIVATION to improve Electrum support, BIP-322 Proof of Reserves and message signing requiring PSBT_GLOBAL_GENERIC_SIGNED_MESSAGE, and the same legacy input amount spoofing fix rejecting witness-utxo-only PSBT inputs where a non-segwit input must be signed, preferring the full non_witness_utxo when both fields are present. Also records keeping the NFC export tag alive for repeated probes to improve iOS tap reliability, warning and skipping fee calculation for legacy UTXOs with only a witness UTXO, disabling Virtual Disk and NFC before HSM activation, repaired P2PK signing, a Delta Mode Trick PIN never restored from backup, and a set of CCC fixes - a key C challenge that crashed the UX on a bad BIP-39 checksum now counts as a wrong attempt toward the 3-strike lockout, a magnitude reset from CANCEL on empty input, and an OP_RETURN Yikes when the whitelist was enabled - plus a TX Explorer crash on foreign inputs with non-standard sighash."
collection: "coldcard"
adapter: git
upstream_id: "releases/History-Q.md"
upstream_type: git-file
revision: "43b2139227149c281141d08c612afd13c434d456"
sha: "c71987d85e056151ba3755fe3971f3e725a7c97d"
canonical_url: "https://github.com/coldcard/firmware/blob/43b2139227149c281141d08c612afd13c434d456/releases/History-Q.md"
