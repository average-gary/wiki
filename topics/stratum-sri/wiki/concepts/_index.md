...
| [SV2 Extensions](sv2-extensions.md) | `extensions_sv2` Extensions Negotiation (0x0001) + Worker-Specific Hashrate Tracking (0x0002) + generic TLV utilities. | sv2, extensions-sv2, tlv | 2026-05-28 |
...
- **Application surface**: sv2-message-handlers, sv2-extensions
