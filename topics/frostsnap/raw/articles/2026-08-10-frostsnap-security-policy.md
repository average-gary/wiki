---
title: "Frostsnap Security Policy and Threat Model"
source: "https://github.com/frostsnap/frostsnap/blob/c319850a77cf077febbd9bccd9dffdf7b666b009/SECURITY.md"
type: articles
ingested: 2026-08-10
tags: [frostsnap, threat-model, security-policy, bug-bounty, coordinated-disclosure, malicious-firmware, threshold-signatures, coordinator-trust]
summary: "Frostsnap's vulnerability-disclosure policy and its explicit three-clause security model: a remote attacker gets nothing even if every device is corrupt (given an honest coordinator app); physical attackers are covered while they control fewer distinct signer shares than the threshold; and a corrupt coordinator app should not cost funds if the user verifies on-device. Pays 1,000,000 satoshi for a genuine break, with a stated carve-out for malicious-backup and ransom scenarios that the protocol cannot prevent."
collection: "frostsnap"
adapter: git
upstream_id: "SECURITY.md"
upstream_type: git-file
revision: "c319850a77cf077febbd9bccd9dffdf7b666b009"
sha: "99130a110a81b03536a033e96998570a81a2c98c"
canonical_url: "https://github.com/frostsnap/frostsnap/blob/c319850a77cf077febbd9bccd9dffdf7b666b009/SECURITY.md"
