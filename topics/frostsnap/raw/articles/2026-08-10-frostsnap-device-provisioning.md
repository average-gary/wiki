---
title: "Frostsnap Device Provisioning and ESP32 Secure Boot v2"
source: "https://github.com/frostsnap/frostsnap/blob/c319850a77cf077febbd9bccd9dffdf7b666b009/frostsnap_factory/PROVISIONING.md"
type: articles
ingested: 2026-08-10
tags: [frostsnap, secure-boot-v2, esp32c3, device-provisioning, efuse, genuine-certificate, factory-batch, nix-build, just-recipes, firmware-signing]
summary: "End-to-end factory provisioning guide for Frostsnap devices: key generation (RSA-3072 Secure Boot signing keys and Schnorr genuine-device-certificate keys), Nix-built ESP-IDF v5.3.1 bootloader, firmware signing, flashing, and factory provisioning of the DS key plus genuine certificate. Explains ESP32 Secure Boot v2 key binding — binaries are key-agnostic at build time, the RSA public key rides in the 4KB signature block, and first boot burns its hash into eFuse. Contrasts dev (JTAG on, SECURE_BOOT_INSECURE) with prod (JTAG permanently disabled) and documents batch provisioning."
collection: "frostsnap"
adapter: git
upstream_id: "frostsnap_factory/PROVISIONING.md"
upstream_type: git-file
revision: "c319850a77cf077febbd9bccd9dffdf7b666b009"
sha: "6f51c8764d892a49c07d1c8a617c296870ee3079"
canonical_url: "https://github.com/frostsnap/frostsnap/blob/c319850a77cf077febbd9bccd9dffdf7b666b009/frostsnap_factory/PROVISIONING.md"
