---
title: "Frostsnap Key Derivation and Recovery Design"
source: "https://github.com/frostsnap/frostsnap/blob/c319850a77cf077febbd9bccd9dffdf7b666b009/docs/key-derivation-design.md"
type: articles
ingested: 2026-08-10
tags: [frostsnap, key-derivation, coordinator-authentication, root-polynomial, share-image, bip32-derivation, xpub-privacy, recovery, threshold-signatures]
summary: "Design document explaining how Frostsnap devices authenticate a coordinator without any coordinator-generated key: each device presents its share image on connect, and once the coordinator holds t of them it reconstructs the root polynomial image as a universal credential. That same root polynomial encrypts each device's key share, so an attacker who seizes one device learns only share images (how many keys and the threshold t). Includes the concrete BIP32-style derivation tree under rootkey (appkey m/0, Bitcoin/Segwitv1 accounts, TestMessage, Nostr) and coordinator-side encryption guidance."
collection: "frostsnap"
adapter: git
upstream_id: "docs/key-derivation-design.md"
upstream_type: git-file
revision: "c319850a77cf077febbd9bccd9dffdf7b666b009"
sha: "09e04ab308ad4d687d25e6f332e2bf7312997778"
canonical_url: "https://github.com/frostsnap/frostsnap/blob/c319850a77cf077febbd9bccd9dffdf7b666b009/docs/key-derivation-design.md"
